  ...
  return (
    <div className="mt-12 px-4 md:px-8 lg:px-16">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
        {/* Text Section */}
        <div>
          <h1 className="text-2xl md:text-3xl font-semibold">Trust with confidence</h1>

          <div className="mt-10 md:mt-16">
            <h2 className="text-xl md:text-2xl font-semibold">Customer-first always</h2>
          ...
          <div className="mt-8 md:mt-10">
            <h2 className="text-xl md:text-2xl font-semibold">No spam or gimmicks</h2>
            <p className="mt-3 text-gray-700">
          ...
          <div className="mt-8 md:mt-10">
            <h2 className="text-xl md:text-2xl font-semibold">The Zerodha universe</h2>
            <p className="mt-3 text-gray-700">
          ...
          <div className="mt-8 md:mt-10">
            <h2 className="text-xl md:text-2xl font-semibold">Do better with money</h2>
            <p className="mt-3 text-gray-700">
